 ...
 */
public class TinyBaseViewHandler<T extends View> {
    /**
    ...
    public TinyBaseViewHandler(Context context, T view, AttributeSet attrs) {
        mView = view;
        mContext = context;
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        TypedArray a = mView.getContext().obtainStyledAttributes(attrs, R.styleable.TinyBaseView);
        //corner
        mCornerRadius = a.getDimensionPixelSize(R.styleable.TinyBaseView_corner_radius, -1);
        mCornerRadiusTopLeft = a.getDimensionPixelSize(R.styleable.TinyBaseView_corner_radius_top_left, 0);
        mCornerRadiusTopRight = a.getDimensionPixelSize(R.styleable.TinyBaseView_corner_radius_top_right, 0);
        mCornerRadiusBottomLeft = a.getDimensionPixelSize(R.styleable.TinyBaseView_corner_radius_bottom_left, 0);
        mCornerRadiusBottomRight = a.getDimensionPixelSize(R.styleable.TinyBaseView_corner_radius_bottom_right, 0);
        //border
        mBorderDashWidth = a.getDimensionPixelSize(R.styleable.TinyBaseView_border_dash_width, 0);
        mBorderDashGap = a.getDimensionPixelSize(R.styleable.TinyBaseView_border_dash_gap, 0);
        mBorderWidthNormal = a.getDimensionPixelSize(R.styleable.TinyBaseView_border_width_normal, 0);
        mBorderWidthPressed = a.getDimensionPixelSize(R.styleable.TinyBaseView_border_width_pressed, 0);
        mBorderWidthUnable = a.getDimensionPixelSize(R.styleable.TinyBaseView_border_width_unable, 0);
        mBorderWidthChecked = a.getDimensionPixelSize(R.styleable.TinyBaseView_border_width_checked, 0);
        mBorderColorNormal = a.getColor(R.styleable.TinyBaseView_border_color_normal, Color.TRANSPARENT);
        mBorderColorPressed = a.getColor(R.styleable.TinyBaseView_border_color_pressed, Color.TRANSPARENT);
        mBorderColorUnable = a.getColor(R.styleable.TinyBaseView_border_color_unable, Color.TRANSPARENT);
        mBorderColorChecked = a.getColor(R.styleable.TinyBaseView_border_color_checked, Color.TRANSPARENT);
        //background
        //normal
        Object[] bgInfoNormal = getBackgroundInfo(a, R.styleable.TinyBaseView_background_normal);
        ...
        //pressed
        Object[] bgInfoPressed = getBackgroundInfo(a, R.styleable.TinyBaseView_background_pressed);
        ...
        //unable
        Object[] bgInfoUnable = getBackgroundInfo(a, R.styleable.TinyBaseView_background_unable);
        ...
        //checked
        Object[] bgInfoChecked = getBackgroundInfo(a, R.styleable.TinyBaseView_background_checked);
        ...
        //gradient
        mGradientType = a.getInt(R.styleable.TinyBaseView_gradient_type, 0);
        mGradientOrientation = getGradientOrientation(a);
        mGradientRadius = a.getDimensionPixelSize(R.styleable.TinyBaseView_gradient_radius, -1);
        mGradientCenterX = a.getFloat(R.styleable.TinyBaseView_gradient_centerX, 0.5f);
        mGradientCenterY = a.getFloat(R.styleable.TinyBaseView_gradient_centerY, 0.5f);
        //enabled
        mIsEnabled = a.getBoolean(R.styleable.TinyBaseView_enabled, true);
    ...
    public TinyBaseViewHandler setGradientRadius(float gradientRadius) {
    ...
    public TinyBaseViewHandler setGradientCenterX(float gradientCenterX) {
    ...
    public TinyBaseViewHandler setGradientCenterY(float gradientCenterY) {
     ...
     * @return
     */
    public TinyBaseViewHandler setGradientType(int gradientType) {
    ...
    public TinyBaseViewHandler setGradientOrientation(GradientDrawable.Orientation orientation) {
    ...
    public TinyBaseViewHandler setStateBackgroundColor(@ColorInt int normal, @ColorInt int pressed, @ColorInt int unable, @ColorInt int checked) {
    ...
    public TinyBaseViewHandler setStateBackgroundColorArray(int[] normalArray, int[] pressedArray, int[] unableArray, int[] checkedArray) {
    ...
    public TinyBaseViewHandler setStateBackgroundColor(Drawable normal, Drawable pressed, Drawable unable, Drawable checked) {
    ...
    public TinyBaseViewHandler setBackgroundColorNormal(@ColorInt int colorNormal) {
    ...
    public TinyBaseViewHandler setBackgroundColorNormalArray(int[] colorNormalArray) {
    ...
    public TinyBaseViewHandler setBackgroundDrawableNormal(Drawable drawableNormal) {
    ...
    public TinyBaseViewHandler setBackgroundColorPressed(@ColorInt int colorPressed) {
    ...
    public TinyBaseViewHandler setBackgroundColorPressedArray(int[] colorPressedArray) {
    ...
    public TinyBaseViewHandler setBackgroundDrawablePressed(Drawable drawablePressed) {
    ...
    public TinyBaseViewHandler setBackgroundColorUnable(@ColorInt int colorUnable) {
    ...
    public TinyBaseViewHandler setBackgroundDrawableUnable(Drawable drawableUnable) {
    ...
    public TinyBaseViewHandler setBackgroundColorUnableArray(int[] colorUnableArray) {
    ...
    public TinyBaseViewHandler setBackgroundColorChecked(@ColorInt int colorChecked) {
    ...
    public TinyBaseViewHandler setBackgroundColorCheckedArray(int[] colorCheckedArray) {
    ...
    public TinyBaseViewHandler setBackgroundDrawableChecked(Drawable drawableChecked) {
    ...
    public TinyBaseViewHandler setBorderWidthNormal(int width) {
    ...
    public TinyBaseViewHandler setBorderColorNormal(@ColorInt int color) {
    ...
    public TinyBaseViewHandler setBorderWidthPressed(int width) {
    ...
    public TinyBaseViewHandler setBorderColorPressed(@ColorInt int color) {
    ...
    public TinyBaseViewHandler setBorderColorChecked(@ColorInt int color) {
    ...
    public TinyBaseViewHandler setBorderWidthChecked(int width) {
    ...
    public TinyBaseViewHandler setBorderWidthUnable(int width) {
    ...
    public TinyBaseViewHandler setBorderColorUnable(@ColorInt int color) {
    ...
    public TinyBaseViewHandler setBorderWidth(int normal, int pressed, int unable, int checked) {
    ...
    public TinyBaseViewHandler setBorderColor(@ColorInt int normal, @ColorInt int pressed, @ColorInt int unable, @ColorInt int checked) {
    ...
    public TinyBaseViewHandler setBorderDashWidth(float dashWidth) {
    ...
    public TinyBaseViewHandler setBorderDashGap(float dashGap) {
    ...
    public TinyBaseViewHandler setBorderDash(float dashWidth, float dashGap) {
        this.mBorderDashWidth = dashWidth;
        this.mBorderDashGap = dashGap;
        setBorder();
        return this;
    ...
    public TinyBaseViewHandler setCornerRadiusTopLeft(float topLeft) {
    ...
    public TinyBaseViewHandler setCornerRadiusTopRight(float topRight) {
        this.mCornerRadius = -1;
    ...
    public TinyBaseViewHandler setCornerRadiusBottomRight(float bottomRight) {
        this.mCornerRadius = -1;
    ...
    public TinyBaseViewHandler setCornerRadiusBottomLeft(float bottomLeft) {
        this.mCornerRadius = -1;
    ...
    public TinyBaseViewHandler setCornerRadius(float topLeft, float topRight, float bottomRight, float bottomLeft) {
        this.mCornerRadius = -1;
        this.mCornerRadiusTopLeft = topLeft;
        this.mCornerRadiusTopRight = topRight;
        this.mCornerRadiusBottomRight = bottomRight;
    ...
    private GradientDrawable.Orientation getGradientOrientation(TypedArray a) {
        ...
        int gradientOrientation = a.getInt(R.styleable.TinyBaseView_gradient_orientation, 0);
